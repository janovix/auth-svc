	...
	test: {
		coverage: {
			...
			exclude: [
				...
				"src/entrypoint.ts", // WorkerEntrypoint — delegates to domain services; requires CF Workers runtime
				"src/index.ts", // Worker default export — requires CF Workers runtime
			],
			thresholds: {
				lines: 60,
				functions: 60,
